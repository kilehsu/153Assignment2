"""
Improved training script for ChoraleTransformer v2.
Uses interleaved voice encoding with weight tying, linear warmup + cosine decay scheduler.
"""
...
def main():
    ...
    if sequences_cache.exists() and tokenizer_path.exists():
    ...
    best_model_path = checkpoint_dir / "v2_transformer_best.pt"
    ...
    print("\nSaving models...")
    final_model_path = checkpoint_dir / "v2_transformer_final.pt"
    ...
    losses_path = checkpoint_dir / "v2_losses.json"
    ...
    try:
        ...
        plot_path = images_dir / "09b_training_curves_v2.png"
